    ...
    <div class="col-12 col-md-10 col-lg-8 mx-auto">
        ...
        <ul class="list-group list-group-flush mb-4">
            ...
            <li class="list-group-item px-0 py-4 bg-transparent">
                ...
                <p class="fs-6">To return your items for free in person, simply stop into any one of
                    our locations and speak
                    to a member of our in-store team.</p>
            </li>
        </ul>
        <div class="bg-light rounded p-3">
            <p class="fs-6">Form more information, please see our returns FAQs <a href="#">here</a>
            </p>
