        ...
        <div class="d-flex flex-column justify-content-between w-100 h-100">
            <div>
                ...
                <div class="row mx-0 pb-4 mb-4 border-bottom">
                    <div class="col-3">
                        <picture class="d-block bg-light">
                            <img class="img-fluid" src="../../../../../Downloads/alpine-html-bootstrap-main/dist/assets/images/products/product-1.jpg"
                ...
                <div class="row mx-0 pb-4 mb-4 border-bottom">
                    <div class="col-3">
                        <picture class="d-block bg-light">
                            <img class="img-fluid" src="../../../../../Downloads/alpine-html-bootstrap-main/dist/assets/images/products/product-2.jpg"
                                 alt="Bootstrap 5 Template by Pixel Rocket">
                        </picture>
                    </div>
                    <div class="col-9">
