...
<head>
    ...
    <!-- FontAwesome -->
    <link href="{{ asset("/vendor/fontawesome-free-6.5.2-web/css/all.css") }}" rel="stylesheet">
...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    {{-- Base Scripts --}}
    @if(!config('adminlte.enabled_laravel_mix'))
{{--        <script src="{{ asset('vendor/jquery/jquery.min.js') }}"></script>  Disable this jQuery load. Newer version loaded with Datatables--}}
